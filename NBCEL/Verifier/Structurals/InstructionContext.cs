...
namespace Apache.NBCEL.Verifier.Structurals
{
	...
	public interface InstructionContext
    {
	    ...
	    /// <seealso cref="GetOutFrame(Sharpen.System.Collections.Generic.List{E})" />
	    /// <returns>
	    ///     true -  if and only if the "outgoing" frame situation
	    ///     changed from the one before execute()ing.
	    /// </returns>
	    bool Execute(Frame inFrame, List
            <InstructionContext> executionPredecessors, InstConstraintVisitor
        ...
        ///     therefore
        ///     <B>
        ///         it has to be calculated by execute(Frame, ArrayList)
        ///         first.
        ///     </B>
        /// </summary>
        /// <seealso cref="Execute(Frame, Sharpen.System.Collections.Generic.List{E}, InstConstraintVisitor, ExecutionVisitor)
        /// 	" />
        Frame GetOutFrame(List<InstructionContext
