...
using Utility = Apache.NBCEL.Verifier.Exc.Utility;
...
namespace Apache.NBCEL.Verifier.Statics
{
	...
	public sealed class Pass1Verifier : PassVerifier
    {
        /// <summary>The Verifier that created this.</summary>
        private readonly Verifier myOwner;

        /// <summary>DON'T USE THIS EVEN PRIVATELY! USE getJavaClass() INSTEAD.</summary>
        /// <seealso cref="GetJavaClass()" />
        ...
        /// <summary>Pass-one verification basically means loading in a class file.</summary>
        /// <remarks>
        ...
        ///                                 <LI>
        ///                                     there are exactly interfaces_count many entries in the interfaces array of the
        ///                                     class file.
        ///                                     <LI>
        ///                                         there are exactly fields_count many entries in the fields array of the class
        ///                                         file.
        ///                                         <LI>
        ///                                             there are exactly methods_count many entries in the methods array of the
        ///                                             class file.
        ///                                             <LI>
        ///                                                 there are exactly attributes_count many entries in the attributes array
        ///                                                 of the class file,
        ///                                                 fields, methods, and code attribute.
        ///                                                 <LI>
        ///                                                     there should be exactly attribute_length many bytes in each
        ///                                                     attribute.
        ///                                                     Inconsistency between attribute_length and the actually size of the
        ///                                                     attribute content should be uncovered.
        ///                                                     For example, in an Exceptions attribute, the actual number of
        ///                                                     exceptions as required by the number_of_exceptions field
        ///                                                     might yeild an attribute size that doesn't match the
        ///                                                     attribute_length. Such an anomaly should be detected.
        ///                                                     <LI>
        ///                                                         all attributes should have proper length. In particular, under
        ///                                                         certain context (e.g. while parsing method_info),
        ///                                                         recognizable attributes (e.g. "Code" attribute) should have
        ///                                                         correct format (e.g. attribute_length is 2).
        ///                     </UL>
        ///                     <LI>
        ...
        ///                                         <LI>
        ///                                             All undocumented access flags are masked off before use. Strictly speaking,
        ///                                             this is not really a check.
        ///                                             <LI>
        ///                                                 The field this_class should point to a string that represents a legal
        ///                                                 non-array class name,
        ///                                                 and this name should be the same as the class file being loaded.
        ///                                                 <LI>
        ///                                                     the field super_class should point to a string that represents a
        ///                                                     legal non-array class name.
        ///                                                     <LI>
        ///                                                         Because some of the above checks require cross referencing the
        ///                                                         constant pool entries,
        ///                                                         guards are set up to make sure that the referenced entries are
        ///                                                         of the right type and the indices
        ///                                                         are within the legal range (0 &lt; index &lt;
        ///                                                         constant_pool_count).
        ///                         </UL>
        ///                         <LI>
        ...
        ///                                         <LI>
        ///                                             the name and signature of fields and methods are verified to be of legal
        ///                                             format.
        ///                             </UL>
        ///     </UL>
        ///     (From the Paper
        ///     <A HREF="http://www.cs.sfu.ca/people/GradStudents/pwfong/personal/JVM/pass1/">
        ///         The Mysterious Pass One, first draft, September 2, 1997
        ///     </A>
        ///     .)
        ///     <P>
        ///         However, most of this is done by parsing a class file or generating a class file into BCEL's internal data
        ///         structure.
        ...
        ///         (like the check for extra bytes at the end of the class file) are handy when actually using BCEL to repair a
        ///         class file
        ///         (otherwise you would not be able to load it into BCEL).
        ///     </P>
        /// </remarks>
        /// <seealso cref="NBCEL.Repository" />
        /// <seealso cref="NBCEL.Const.JVM_CLASSFILE_MAGIC" />
        public override VerificationResult Do_verify()
        {
            ...
            try
            {
                ...
                if (jc != null)
                    ...
                    if (!myOwner.GetClassName().Equals(jc.GetClassName()))
                        ...
                        throw new LoadingException("Wrong name: the internal name of the .class file '"
                                                   + jc.GetClassName() + "' does not match the file's name '" +
            ...
            catch (Exception e)
            {
                ...
                return new VerificationResult(VerificationResult.VERIFIED_REJECTED
                    , "Parsing via BCEL did not succeed. " + e.GetType().FullName + " occured:\n" +
                      Utility.GetStackTrace(e));
            }

            if (jc != null) return VerificationResult.VR_OK;
        ...
        /// <summary>Currently this returns an empty array of String.</summary>
        /// <remarks>
