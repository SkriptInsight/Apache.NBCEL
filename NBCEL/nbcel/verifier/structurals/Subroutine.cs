...
namespace NBCEL.verifier.structurals
{
	...
	{
		/// <summary>Returns all the JsrInstructions that have the first instruction of this subroutine as their target.
		/// 	</summary>
		/// <remarks>
		...
		/// 	</returns>
		NBCEL.generic.InstructionHandle[] GetEnteringJsrInstructions();
		...
		NBCEL.generic.InstructionHandle GetLeavingRET();
		...
		NBCEL.generic.InstructionHandle[] GetInstructions();

		/// <summary>Returns if the given InstructionHandle refers to an instruction that is part of this subroutine.
		/// 	</summary>
		/// <remarks>
		...
		bool Contains(NBCEL.generic.InstructionHandle inst);
		...
		NBCEL.verifier.structurals.Subroutine[] SubSubs();
	}
}
