...
namespace NBCEL.verifier.statics
{
	...
	public sealed class Pass3aVerifier : PassVerifier
    {
        ...
        ///     Code attribute.
        /// </remarks>
        /// <exception cref="NBCEL.verifier.exc.InvalidMethodException">
        ...
        /// </remarks>
        /// <exception cref="NBCEL.verifier.exc.ClassConstraintException">
        ...
        /// </summary>
        /// <exception cref="NBCEL.verifier.exc.StaticCodeConstraintException">
        ///     if the verification fails.
        /// </exception>
        ...
        /// </summary>
        private class InstOperandConstraintVisitor : EmptyVisitor
        {
