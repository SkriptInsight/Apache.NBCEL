...
using Sharpen;
using EmptyVisitor = NBCEL.classfile.EmptyVisitor;
...
namespace NBCEL.verifier.statics
{
	...
	public sealed class Pass2Verifier : PassVerifier
    {
        ...
        private sealed class CPESSC_Visitor : EmptyVisitor
        {
        ...
        private sealed class FAMRAV_Visitor : EmptyVisitor
        {
            private readonly Pass2Verifier _enclosing;
            private readonly ConstantPool cp;
        ...
        /// </remarks>
        private class InnerClassDetector : EmptyVisitor
        {
            private readonly ConstantPool cp;
