...
namespace NBCEL.verifier
{
	...
	public abstract class PassVerifier
	{
		...
		private readonly System.Collections.Generic.List<string> messages = new System.Collections.Generic.List
			<string>();

		/// <summary>The VerificationResult cache.</summary>
		private NBCEL.verifier.VerificationResult verificationResult = null;
		...
		public virtual NBCEL.verifier.VerificationResult Verify()
		{
		...
		public abstract NBCEL.verifier.VerificationResult Do_verify();
