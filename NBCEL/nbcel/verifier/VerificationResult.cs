...
namespace NBCEL.verifier
{
	...
	public class VerificationResult
    {
        ...
        ///     .
        /// </remarks>
        public static readonly VerificationResult VR_NOTYET = new VerificationResult
            (VERIFIED_NOTYET, VERIFIED_NOTYET_MSG);

        /// <summary>Canonical VerificationResult for passed verifications.</summary>
        public static readonly VerificationResult VR_OK = new VerificationResult
        ...
        {
            if (!(o is VerificationResult)) return false;
            var other = (VerificationResult) o;
            return other.numeric == numeric && other.detailMessage.Equals(detailMessage
                   );
        }
