...
namespace NBCEL.verifier.exc
{
	...
	/// </remarks>
	[System.Serializable]
	public sealed class AssertionViolatedException : System.Exception
	{
		...
		/// <summary>Constructs a new AssertionViolatedException with null as its error message string.
		/// 	</summary>
		...
		/// <summary>Constructs a new AssertionViolationException with the specified error message and initial cause
		/// 	</summary>
		/// <since>6.0</since>
		public AssertionViolatedException(string message, System.Exception initCause)
		...
		/// <summary>Returns the error message string of this AssertionViolatedException object.
		/// 	</summary>
		...
		{
			NBCEL.verifier.exc.AssertionViolatedException ave = new NBCEL.verifier.exc.AssertionViolatedException
				("Oops!");
			ave.ExtendMessage("\nFOUND:\n\t", "\nExiting!!\n");
			throw ave;
		}
