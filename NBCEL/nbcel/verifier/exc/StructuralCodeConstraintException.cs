...
namespace NBCEL.verifier.exc
{
	...
	/// </remarks>
	[System.Serializable]
	public class StructuralCodeConstraintException : NBCEL.verifier.exc.CodeConstraintException
	{
		private const long serialVersionUID = 5406842000007181420L;

		/// <summary>Constructs a new StructuralCodeConstraintException with the specified error message.
		/// 	</summary>
		...
		/// <summary>Constructs a new StructuralCodeConstraintException with null as its error message string.
		/// 	</summary>
