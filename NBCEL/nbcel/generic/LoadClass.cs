...
namespace NBCEL.generic
{
	...
	public interface LoadClass
	{
		...
		/// referenced
		/// </returns>
		NBCEL.generic.ObjectType GetLoadClassType(NBCEL.generic.ConstantPoolGen cpg);

		/// <summary>Returns the type associated with this instruction.</summary>
		/// <remarks>
		...
		/// an int[][].
		/// </remarks>
		/// <seealso cref="GetLoadClassType(ConstantPoolGen)"/>
