...
namespace NBCEL.generic
{
	...
	public sealed class BranchHandle : NBCEL.generic.InstructionHandle
	{
		private NBCEL.generic.BranchInstruction bi;

		private BranchHandle(NBCEL.generic.BranchInstruction i)
			: base(i)
		{
		...
		internal static NBCEL.generic.BranchHandle GetBranchHandle(NBCEL.generic.BranchInstruction
			 i)
		{
			return new NBCEL.generic.BranchHandle(i);
		}
		...
		*/
		...
		public void SetTarget(NBCEL.generic.InstructionHandle ih)
		{
			bi.SetTarget(ih);
		}
		...
		public NBCEL.generic.InstructionHandle GetTarget()
		{
			return bi.GetTarget();
		}

		/// <summary>Set new contents.</summary>
		/// <remarks>Set new contents. Old instruction is disposed and may not be used anymore.
		/// 	</remarks>
		public override void SetInstruction(NBCEL.generic.Instruction i)
		{
			...
			{
				throw new NBCEL.generic.ClassGenException("Assigning " + i + " to branch handle which is not a branch instruction"
					);
			}
			bi = (NBCEL.generic.BranchInstruction)i;
		}
	}
}
