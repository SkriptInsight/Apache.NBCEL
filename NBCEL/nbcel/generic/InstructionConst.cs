...
namespace NBCEL.generic
{
	...
	public sealed class InstructionConst
    {
        ...
        public static readonly Instruction ICONST_M1 = new ICONST
            (-1);

        public static readonly Instruction ICONST_0 = new ICONST
            (0);

        public static readonly Instruction ICONST_1 = new ICONST
            (1);

        public static readonly Instruction ICONST_2 = new ICONST
            (2);

        public static readonly Instruction ICONST_3 = new ICONST
            (3);

        public static readonly Instruction ICONST_4 = new ICONST
            (4);

        public static readonly Instruction ICONST_5 = new ICONST
            (5);

        public static readonly Instruction LCONST_0 = new LCONST
            (0);

        public static readonly Instruction LCONST_1 = new LCONST
            (1);

        public static readonly Instruction FCONST_0 = new FCONST
            (0);

        public static readonly Instruction FCONST_1 = new FCONST
            (1);

        public static readonly Instruction FCONST_2 = new FCONST
            (2);

        public static readonly Instruction DCONST_0 = new DCONST
            (0);

        public static readonly Instruction DCONST_1 = new DCONST
            (1);
