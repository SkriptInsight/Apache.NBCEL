...
namespace NBCEL.generic
{
	...
	/// </remarks>
	public sealed class InstructionConst
	{
		...
		public static readonly NBCEL.generic.Instruction ICONST_M1 = new NBCEL.generic.ICONST
			(-1);

		public static readonly NBCEL.generic.Instruction ICONST_0 = new NBCEL.generic.ICONST
			(0);

		public static readonly NBCEL.generic.Instruction ICONST_1 = new NBCEL.generic.ICONST
			(1);

		public static readonly NBCEL.generic.Instruction ICONST_2 = new NBCEL.generic.ICONST
			(2);

		public static readonly NBCEL.generic.Instruction ICONST_3 = new NBCEL.generic.ICONST
			(3);

		public static readonly NBCEL.generic.Instruction ICONST_4 = new NBCEL.generic.ICONST
			(4);

		public static readonly NBCEL.generic.Instruction ICONST_5 = new NBCEL.generic.ICONST
			(5);

		public static readonly NBCEL.generic.Instruction LCONST_0 = new NBCEL.generic.LCONST
			(0);

		public static readonly NBCEL.generic.Instruction LCONST_1 = new NBCEL.generic.LCONST
			(1);

		public static readonly NBCEL.generic.Instruction FCONST_0 = new NBCEL.generic.FCONST
			(0);

		public static readonly NBCEL.generic.Instruction FCONST_1 = new NBCEL.generic.FCONST
			(1);

		public static readonly NBCEL.generic.Instruction FCONST_2 = new NBCEL.generic.FCONST
			(2);

		public static readonly NBCEL.generic.Instruction DCONST_0 = new NBCEL.generic.DCONST
			(0);

		public static readonly NBCEL.generic.Instruction DCONST_1 = new NBCEL.generic.DCONST
			(1);
		...
		/// </summary>
		private static readonly NBCEL.generic.Instruction[] INSTRUCTIONS = new NBCEL.generic.Instruction
			[256];
		...
		/// <param name="index">
		/// the index, e.g.
		/// <see cref="NBCEL.Const.RETURN"/>
		/// </param>
		/// <returns>the entry from the private INSTRUCTIONS table</returns>
		public static NBCEL.generic.Instruction GetInstruction(int index)
		{
