...
namespace NBCEL.classfile
{
	...
	[System.ObsoleteAttribute(@"Use UnknownAttributeReader instead")]
	public interface AttributeReader
	{
		...
		/// </param>
		/// <param name="length">
		/// The length of the data contained in the attribute.  This
		...
		/// </returns>
		/// <seealso cref="Attribute.AddAttributeReader(string, AttributeReader)"/>
		NBCEL.classfile.Attribute CreateAttribute(int name_index, int length, java.io.DataInputStream
