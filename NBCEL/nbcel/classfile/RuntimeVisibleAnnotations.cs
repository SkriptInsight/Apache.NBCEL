...
namespace NBCEL.classfile
{
	...
	/// </summary>
	/// <since>6.0</since>
	public class RuntimeVisibleAnnotations : NBCEL.classfile.Annotations
	{
		...
		public RuntimeVisibleAnnotations(int name_index, int length, java.io.DataInput input
			, NBCEL.classfile.ConstantPool constant_pool)
			: base(NBCEL.Const.ATTR_RUNTIME_VISIBLE_ANNOTATIONS, name_index, length, input, constant_pool
				, true)
		{
		}
