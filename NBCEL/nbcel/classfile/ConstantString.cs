...
namespace NBCEL.classfile
{
	...
	public sealed class ConstantString : NBCEL.classfile.Constant, NBCEL.classfile.ConstantObject
	{
		private int string_index;

		/// <summary>Initialize from another object.</summary>
		public ConstantString(NBCEL.classfile.ConstantString c)
		...
		internal ConstantString(java.io.DataInput file)
		...
		public ConstantString(int string_index)
			: base(NBCEL.Const.CONSTANT_String)
		{
		...
		{
			NBCEL.classfile.Constant c = cp.GetConstant(string_index, NBCEL.Const.CONSTANT_Utf8
				);
