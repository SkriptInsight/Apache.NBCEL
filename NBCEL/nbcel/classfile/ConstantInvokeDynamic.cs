...
namespace NBCEL.classfile
{
	...
	/// 	</seealso>
	/// <since>6.0</since>
	public sealed class ConstantInvokeDynamic : NBCEL.classfile.ConstantCP
	{
		/// <summary>Initialize from another object.</summary>
		public ConstantInvokeDynamic(NBCEL.classfile.ConstantInvokeDynamic c)
		...
		internal ConstantInvokeDynamic(java.io.DataInput file)
		...
		public ConstantInvokeDynamic(int bootstrap_method_attr_index, int name_and_type_index
			...
			: base(NBCEL.Const.CONSTANT_InvokeDynamic, bootstrap_method_attr_index, name_and_type_index
				)
		{
		}
