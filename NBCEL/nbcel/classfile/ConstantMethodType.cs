...
namespace NBCEL.classfile
{
	...
	/// <since>6.0</since>
	public sealed class ConstantMethodType : NBCEL.classfile.Constant
	{
		private int descriptor_index;

		/// <summary>Initialize from another object.</summary>
		public ConstantMethodType(NBCEL.classfile.ConstantMethodType c)
		...
		internal ConstantMethodType(java.io.DataInput file)
			: this(file.ReadUnsignedShort())
		{
		}

		public ConstantMethodType(int descriptor_index)
			: base(NBCEL.Const.CONSTANT_MethodType)
		{
