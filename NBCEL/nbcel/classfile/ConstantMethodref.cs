...
namespace NBCEL.classfile
{
	...
	public sealed class ConstantMethodref : NBCEL.classfile.ConstantCP
	{
		/// <summary>Initialize from another object.</summary>
		public ConstantMethodref(NBCEL.classfile.ConstantMethodref c)
			: base(NBCEL.Const.CONSTANT_Methodref, c.GetClassIndex(), c.GetNameAndTypeIndex()
				)
		{
		}
		...
		internal ConstantMethodref(java.io.DataInput input)
			: base(NBCEL.Const.CONSTANT_Methodref, input)
		{
		}
		...
		public ConstantMethodref(int class_index, int name_and_type_index)
			: base(NBCEL.Const.CONSTANT_Methodref, class_index, name_and_type_index)
		{
		}
