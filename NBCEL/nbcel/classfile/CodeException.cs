...
namespace NBCEL.classfile
{
	...
	/// </remarks>
	/// <seealso cref="Code"/>
	public sealed class CodeException : System.ICloneable, NBCEL.classfile.Node
	{
		...
		public CodeException(NBCEL.classfile.CodeException c)
		...
		internal CodeException(java.io.DataInput file)
		...
		/// <returns>String representation.</returns>
		public string ToString(NBCEL.classfile.ConstantPool cp, bool verbose)
		{
			string str;
			if (catch_type == 0)
			{
			...
			{
				str = NBCEL.classfile.Utility.CompactClassName(cp.GetConstantString(catch_type, NBCEL.Const
					.CONSTANT_Class), false) + (verbose ? "(" + catch_type + ")" : string.Empty);
			}
			return start_pc + "\t" + end_pc + "\t" + handler_pc + "\t" + str;
		}

		public string ToString(NBCEL.classfile.ConstantPool cp)
		{
			return ToString(cp, true);
		}

		/// <returns>deep copy of this object</returns>
		public NBCEL.classfile.CodeException Copy()
		{
			return (NBCEL.classfile.CodeException)MemberwiseClone();
