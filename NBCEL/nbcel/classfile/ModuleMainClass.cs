...
namespace NBCEL.classfile
{
	...
	public sealed class ModuleMainClass : Attribute
    {
        ...
        public ModuleMainClass(int name_index, int length, int main_class_index, ConstantPool
            constant_pool)
        ...
        internal ModuleMainClass(int name_index, int length, DataInput input, ConstantPool
            constant_pool)
        ...
        public override string ToString()
        {
            ...
            var class_name = GetConstantPool().GetConstantString(main_class_index, Const
                .CONSTANT_Class);
