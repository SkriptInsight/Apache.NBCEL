...
namespace NBCEL.classfile
{
	...
	public interface UnknownAttributeReader
    {
	    ...
	    /// </param>
	    /// <param name="file">
	    ///     This is the data input that the factory needs to read its data from.
	    /// </param>
	    /// <param name="constant_pool">
	    ///     This is the constant pool associated with the Attribute that we are constructing.
	    /// </param>
	    /// <returns>
	    ...
	    Attribute CreateAttribute(int name_index, int length, DataInput
