...
namespace NBCEL
{
	...
	{
		private static NBCEL.util.Repository repository = NBCEL.util.SyntheticRepository.
			GetInstance();

		/// <returns>currently used repository instance</returns>
		public static NBCEL.util.Repository GetRepository()
		{
			return repository;
		}

		/// <summary>Sets repository instance to be used for class loading</summary>
		public static void SetRepository(NBCEL.util.Repository rep)
		{
			repository = rep;
		}
		...
		/// parsed correctly
		/// </exception>
		public static NBCEL.classfile.JavaClass LookupClass(string class_name)
		{
		...
		/// parsed correctly
		/// </exception>
		public static NBCEL.classfile.JavaClass LookupClass(System.Type clazz)
		{
		...
		/// found
		/// </returns>
		public static NBCEL.util.ClassPath.ClassFile LookupClassFile(string class_name)
		{
			try
			{
				NBCEL.util.ClassPath path = repository.GetClassPath();
				if (path == null)
				{
					return null;
				}
		...
		/// <summary>Adds clazz to repository if there isn't an equally named class already in there.
		/// 	</summary>
		/// <returns>old entry in repository</returns>
		public static NBCEL.classfile.JavaClass AddClass(NBCEL.classfile.JavaClass clazz)
		{
			NBCEL.classfile.JavaClass old = repository.FindClass(clazz.GetClassName());
		...
		public static void RemoveClass(NBCEL.classfile.JavaClass clazz)
		{
		...
		/// </returns>
		/// <exception cref="System.TypeLoadException">if any of the superclasses can't be found
		/// 	</exception>
		public static NBCEL.classfile.JavaClass[] GetSuperClasses(NBCEL.classfile.JavaClass
			 clazz)
		{
		...
		/// </exception>
		public static NBCEL.classfile.JavaClass[] GetSuperClasses(string class_name)
		{
			NBCEL.classfile.JavaClass jc = LookupClass(class_name);
		...
		/// </exception>
		public static NBCEL.classfile.JavaClass[] GetInterfaces(NBCEL.classfile.JavaClass
			 clazz)
		{
		...
		/// </exception>
		public static NBCEL.classfile.JavaClass[] GetInterfaces(string class_name)
		{
		...
		/// </exception>
		public static bool InstanceOf(NBCEL.classfile.JavaClass clazz, NBCEL.classfile.JavaClass
			 super_class)
		{
		...
		public static bool InstanceOf(NBCEL.classfile.JavaClass clazz, string super_class
			)
		{
		...
		public static bool InstanceOf(string clazz, NBCEL.classfile.JavaClass super_class
			)
		{
		...
		/// of clazz can't be found
		/// </exception>
		public static bool ImplementationOf(NBCEL.classfile.JavaClass clazz, NBCEL.classfile.JavaClass
			 inter)
		{
		...
		/// or superinterfaces of clazz can't be found
		/// </exception>
		public static bool ImplementationOf(NBCEL.classfile.JavaClass clazz, string inter
			)
		{
		...
		/// </exception>
		public static bool ImplementationOf(string clazz, NBCEL.classfile.JavaClass inter
			)
		{
