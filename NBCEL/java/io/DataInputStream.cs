...
namespace java.io
{
    ...
    public class DataInputStream : FilterInputStream, DataInput
    {
        ...
        public void ReadFully(byte[] b, int off, int len)
        {
            ...
            while (n < len)
            {
                var count = @in.Read(b, off + n, len - n);
        ...
        /// </exception>
        /// <seealso cref="BufferedReader.ReadLine()" />
        /// <seealso cref="FilterInputStream.@in" />
        /// <exception cref="System.IO.IOException" />
        [Obsolete(
            ...
            while (true)
                switch (c = @in.Read())
                {
                    ...
                    case '\r':
                    {
                        ...
                        if (c2 != '\n' && c2 != -1)
                        {
                            if (!(@in is PushbackInputStream)) @in = new PushbackInputStream(@in);
