...
namespace Apache.NBCEL.ClassFile
{
	...
	/// <since>6.1</since>
	public sealed class ConstantModule : Constant, ConstantObject
    {
        ...
        internal ConstantModule(DataInput file)
        ...
        /// <param name="name_index">
        ///     the name index in the constant pool of this Constant Module
        /// </param>
