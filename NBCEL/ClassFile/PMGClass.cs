...
namespace Apache.NBCEL.ClassFile
{
	...
	public sealed class PMGClass : Attribute
    {
        ...
        internal PMGClass(int name_index, int length, DataInput input, ConstantPool
            constant_pool)
        ...
        /// <param name="constant_pool">Array of constants</param>
        public PMGClass(int name_index, int length, int pmg_index, int pmg_class_index, ConstantPool
            constant_pool)
            : base(Const.ATTR_PMG, name_index, length, constant_pool)
        {
        ...
        public string GetPMGName()
        {
            var c = (ConstantUtf8) GetConstantPool
                ().GetConstant(pmg_index, Const.CONSTANT_Utf8);
            return c.GetBytes();
        }
        ...
        {
            var c = (ConstantUtf8) GetConstantPool
                ().GetConstant(pmg_class_index, Const.CONSTANT_Utf8);
            return c.GetBytes();
        }
