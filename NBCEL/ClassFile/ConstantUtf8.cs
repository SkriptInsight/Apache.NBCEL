...
namespace Apache.NBCEL.ClassFile
{
	...
	public sealed class ConstantUtf8 : Constant
    {
        ...
        private class Cache
        {
            private static readonly bool BCEL_STATISTICS = System.GetBoolean(SYS_PROP_STATISTICS
            );

            internal static readonly int MAX_ENTRIES = System.GetInteger(SYS_PROP_CACHE_MAX_ENTRIES
                , 0);
            ...
            internal static readonly int MAX_ENTRY_SIZE = System.GetInteger(SYS_PROP_CACHE_MAX_ENTRY_SIZE
                , 200);
