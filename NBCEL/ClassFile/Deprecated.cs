...
namespace Apache.NBCEL.ClassFile
{
	...
	public sealed class Deprecated : Attribute
    {
        private byte[] bytes;
        ...
        public Deprecated(int name_index, int length, byte[] bytes, ConstantPool
            constant_pool)
            : base(Const.ATTR_DEPRECATED, name_index, length, constant_pool)
        {
            this.bytes = bytes;
        }
        ...
        internal Deprecated(int name_index, int length, DataInput input, ConstantPool
            constant_pool)
